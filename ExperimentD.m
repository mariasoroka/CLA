...
[x_G_LS_dense, log_resid_G_LS_dense, log_x_G_LS_dense, log_time_G_LS_dense, log_flops_G_LS_dense, ~] = Gauss_LS(A, b, e, 15, true);
%% Solve system using GK
[x_GK_dense, log_resid_GK_dense, log_x_GK_dense, log_time_GK_dense, log_flops_GK_dense, ~] = GK(A, b, e, 15, true);
%% Solve system using RK
[x_RK_dense, log_resid_RK_dense, log_x_RK_dense, log_time_RK_dense, log_flops_RK_dense, ~] = RK(A, b, e, 15, true);
%% Solve system using CD_LS
[x_CD_LS_dense, log_resid_CD_LS_dense, log_x_CD_LS_dense, log_time_CD_LS_dense, log_flops_CD_LS_dense, ~] = CD_LS(A, b, e, 15, true);
...
%% Solve system using GK
[x_GK_sparse, log_resid_GK_sparse, log_x_GK_sparse, log_time_GK_sparse, log_flops_GK_sparse, ~] = GK(A, b, e, 15, true);
%% Solve system using RK
[x_RK_sparse, log_resid_RK_sparse, log_x_RK_sparse, log_time_RK_sparse, log_flops_RK_sparse, ~] = RK(A, b, e, 15, true);
%% Solve system using CD_LS
